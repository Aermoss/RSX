from main import interpreter, parser, lexer
...
def include_library(file, namespace, enviroment):
    ...
    if ext == ".py":
        ...
        temp = interpreter(parser(lexer(read_file(file_path), file_path, enviroment["create_json"]), file_path, enviroment["create_json"]), file_path, False, False, {}, {}, None, {}, enviroment["include_folders"], enviroment["create_json"])
...
def run_function(name, enviroment):
    temp = interpreter(enviroment["functions"][name]["ast"], enviroment["file"], False, False, enviroment["functions"], enviroment["variables"], enviroment["functions"][name]["type"], enviroment["library_functions"])
